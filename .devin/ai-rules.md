...
- **Angular:** ^21.2.0 (zoneless change detection)
- **PrimeNG:** ^21.1.8 — styled theming via @primeuix/themes
- **@primeuix/themes installed:** yes | **theme import correct:** yes
- **darkModeSelector:** .dark (dark = `.dark`, light = `[data-theme="light"]`)
- **Tailwind v4:** yes | **SSR (@angular/ssr):** yes
- **Test runner:** vitest
- **Zod installed:** yes | **DOMPurify installed:** yes
...
# Source: .claude/rules/angular-rules.md
